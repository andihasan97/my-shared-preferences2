package com.andihasan7.mysharedpreferences2
...
import com.andihasan7.mysharedpreferences2.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        if (view.id == R.id.btn_save) {
            ...
            // urutan pengecekan if harus sama dng urutan variable diatas
            if (name.isEmpty()) {
    ...
    // kode agar bisa kembali ke MainActivity
